import 'koa'
import * as cookies from '@types/cookies'
import 'next/dist/compiled/@edge-runtime/cookies'

export type CookiesKey= 'theme'|'lang'|'user'|'_user'|'_ins'|'last-page'
  |'chg_email'|'del_compte'

declare module "next/dist/compiled/@edge-runtime/cookies" {
  ///copie - temporaire //TODO: ReadonlyRequestCookies
    /**
  ...
  export interface RequestCookies {
    get(...args: [name: CookiesKey]): RequestCookie | undefined
  }
}

declare module "koa" {
  interface Cookies extends cookies {
    /**
     ...
     */
    get(name: CookiesKey, opts?: Cookies.GetOption): string | undefined
     ...
     */
    set(name: CookiesKey, value?: string | null, opts?: Cookies.SetOption): this
  }
}
...
declare global {
  ...
  interface TriggerEventMap {
    "lang": CustomEvent<{value:string}>
    "theme": CustomEvent<{value:"dark"|"light"}>
    "refresh": CustomEvent<{signal?:boolean}>
    "signal-refresh": CustomEvent<undefined>
  }
  
  interface WindowEventMap extends TriggerEventMap {}
  interface DocumentEventMap extends TriggerEventMap {}
  interface HTMLElementEventMap extends TriggerEventMap {}
}